...
Packages <- c("tidyverse", "sf", "stars", "rnaturalearth", "raster", "exactextractr")                  # List handy packages
...
mask_accurate <- readRDS("./Objects/Domains-accurate.rds") %>%  filter(Shore == "Offshore")
