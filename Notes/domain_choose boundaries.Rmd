---
title: "Choosing StrathE2E domain extent - Ascension Island"
...
The model domain is shown in grey with white borders, while the fishing effort is shown as a heatmap on a log scale. By using the EEZ to define the model domain, we accurately represent the protected status of Ascension. Based on documents we saw on teams it seemed the EEZ was the area of interest. If this is not the case, and you want a smaller offshore zone, let us know what to change.
